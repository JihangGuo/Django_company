...
SECRET_KEY = '1wsq0$j=urn4@qm0imwy1n10wq=j77w1j)1ye@)57!f)fqhlec'
...
MEDIA_URL = '/static_pic/'

MEDIA_ROOT = os.path.join(os.path.dirname(__file__),'picdb')
